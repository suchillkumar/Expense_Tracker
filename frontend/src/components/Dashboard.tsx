    ...
    <div className="space-y-7 animate-fade-in pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-white dark:bg-[#0F172A] border border-[#E2E8F0] dark:border-slate-800 text-[#0F172A] dark:text-slate-200 text-xs font-bold hover:bg-[#F8FAFC] dark:hover:bg-slate-800 transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 fintech-card p-6 flex flex-col justify-between">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
            ...
            <div className="flex items-center gap-1 bg-[#F8FAFC] dark:bg-slate-800 p-1 rounded-xl border border-[#E2E8F0] dark:border-slate-700 self-start sm:self-auto">
      ...
      <div className="fintech-card p-6">
        ...
        {budgetProgress.length === 0 ? (
          <div className="py-8 text-center text-xs text-[#64748B] dark:text-slate-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {budgetProgress.slice(0, 6).map((b) => (
              <div
                key={b.id || b.category}
                className="p-4 rounded-2xl bg-white dark:bg-slate-800/60 border border-[#E2E8F0] dark:border-slate-700/60 shadow-xs space-y-2.5 transition-all hover:shadow-md"
              >
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-baseline justify-between text-xs font-semibold">
                  ...
                  <span className="text-[#64748B] dark:text-slate-400 tabular-numbers">
                ...
                <div className="flex items-center justify-between text-[11px] font-medium pt-0.5">
                  <span className="text-[#64748B] dark:text-slate-400">Remaining</span>
                  <span
      ...
      <div className="fintech-card p-6 bg-white dark:bg-slate-900 border border-[#E2E8F0] dark:border-slate-800 relative overflow-hidden">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748B] dark:text-slate-400">Continuous personalized spending intelligence</p>
            </div>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-800/80 border border-red-100 dark:border-red-950/40 shadow-xs space-y-2">
            <div className="flex items-center gap-2">
          ...
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-800/80 border border-emerald-100 dark:border-emerald-950/40 shadow-xs space-y-2">
            <div className="flex items-center gap-2">
          ...
          {/* Card 3: Smart Budget */}
          <div className="p-4 rounded-2xl bg-white dark:bg-slate-800/80 border border-purple-100 dark:border-purple-950/40 shadow-xs space-y-2">
            <div className="flex items-center gap-2">
      ...
      <div className="fintech-card p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-[#64748B] dark:text-slate-400 mt-0.5">Latest account inflows and outflows</p>
          </div>
          <button
        ...
        {recentTransactions.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-[#E2E8F0] dark:border-slate-800 text-[11px] font-bold text-[#64748B] dark:text-slate-400 uppercase tracking-wider">
                  ...
                  >
                    <td className="py-3 px-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-xl bg-gray-100 dark:bg-slate-800 flex items-center justify-center text-sm shrink-0">
                        ...
                        <div>
                          ...
                          {tx.notes && (
                            <p className="text-[10px] text-[#64748B] dark:text-slate-400 truncate max-w-xs mt-0.5">
                              {tx.notes}
                            </p>
                          )}
                        </div>
                    ...
                    <td className="py-3 px-3">
                      <span className="px-2.5 py-1 rounded-lg text-[11px] font-semibold bg-gray-100 dark:bg-slate-800 text-[#0F172A] dark:text-slate-200">
                        {tx.category}
                      </span>
                    </td>
                    <td className="py-3 px-3 text-[#64748B] dark:text-slate-400 font-medium whitespace-nowrap">
